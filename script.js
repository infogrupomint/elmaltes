...
const products = {
  'Pizzas': [
    ...
    { id: 6, name: 'P. Papas Fritas', price: 8500, quantity:1 },
    { id: 7, name: 'P. Fritas c/Salame', price: 8500, quantity:1 },
    { id: 8, name: 'P. Provolone c/Jamon', price: 9000, quantity:1 },
    { id: 9, name: 'P. Calabresa', price: 9000, quantity:1 },
    { id: 10, name: 'P. Rucula c/ Parmesano', price: 8500, quantity:1 },
    { id: 11, name: 'P. Rucula c/ Crudo', price: 9000, quantity:1 },
    { id: 12, name: 'P. Palmitos', price: 9000, quantity:1 },
    { id: 13, name: 'P. Choclo', price: 9000, quantity:1 },
    { id: 14, name: 'P. Panceta', price: 9000, quantity:1 },
    { id: 15, name: 'P. Anana c/ Jamon', price: 8200, quantity:1 },
    { id: 16, name: 'P. Pollo', price: 8200, quantity:1 },
    { id: 17, name: 'P. Roquefort', price: 9000, quantity:1 },
    { id: 18, name: 'P. 4 Quesos', price: 9000, quantity:1 },
    { id: 19, name: 'P. Anchoas', price: 9000, quantity:1 },
    { id: 20, name: 'P. Veranito', price: 9000, quantity:1 },
    { id: 21, name: 'P. S.O.S', price: 9000, quantity:1 },
    { id: 22, name: 'P. Cordoba', price: 9000, quantity:1 },

  ],

  '1/2 Pizza': [
    { id: 23, name: '1/2 P. Muzzarella', price: 3000, quantity: 1,},
    { id: 24, name: '1/2 P. Especial', price: 4250, quantity: 1, },
    { id: 25, name: '1/2 P. Cebolla', price: 3950, quantity:1 },
    { id: 26, name: '1/2 P. Napolitana', price: 4500, quantity:1 },
    { id: 27, name: '1/2 P. Capresse', price: 3975, quantity:1 },
    { id: 28, name: '1/2 P. Papas Fritas', price: 4250, quantity:1 },
    { id: 29, name: '1/2 P. Fritas c/Salame', price: 4250, quantity:1 },
    { id: 30, name: '1/2 P. Provolone c/Jamon', price: 4500, quantity:1 },
    { id: 31, name: '1/2 P. Calabresa', price: 4500, quantity:1 },
    { id: 32, name: '1/2 P. Rucula c/ Parmesano', price: 4250, quantity:1 },
    { id: 33, name: '1/2 P. Rucula c/ Crudo', price: 4500, quantity:1 },
    { id: 34, name: '1/2 P. Palmitos', price: 4500, quantity:1 },
    { id: 35, name: '1/2 P. Choclo', price: 4500, quantity:1 },
    { id: 36, name: '1/2 P. Panceta', price: 4500, quantity:1 },
    { id: 37, name: '1/2 P. Anana c/ Jamon', price: 4100, quantity:1 },
    { id: 38, name: '1/2 P. Pollo', price: 4100, quantity:1 },
    { id: 39, name: '1/2 P. Roquefort', price: 4500, quantity:1 },
    { id: 40, name: '1/2 P. 4 Quesos', price: 4500, quantity:1 },
    { id: 41, name: '1/2 P. Anchoas', price: 4500, quantity:1 },
    { id: 42, name: '1/2 P. Veranito', price: 4500, quantity:1 },
    { id: 43, name: '1/2 P. S.O.S', price: 4500, quantity:1 },
    { id: 44, name: '1/2 P. Cordoba', price: 4500, quantity:1 },
  ...
  'Sandwiches': [
    { id: 55, name: 'Milanesa c/ Fritas', price: 4200, quantity:1 },
    { id: 56, name: 'Hamburguesa c/ Fritas', price: 4800, quantity:1 },
    { id: 57, name: 'Lomo c/ Fritas', price: 6500, quantity:1 },
    { id: 58, name: 'Lomopizza', price: 23500, quantity:1 },
